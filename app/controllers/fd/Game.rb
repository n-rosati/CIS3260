class Game
	...
	def initialize(player1, player2, board, phase, turn_colour)
		if !player1.instance_of?(GamePlayer)
			raise TypeError("First parameter must be an instance of GamePlayer")
		elsif !player2.instance_of?(GamePlayer)
			raise TypeError("Second parameter must be an instance of GamePlayer")
		...
		@ref = Referee.new(board, turn_colour)
		@winner = nil
		@draw_flag = :unset
	end
